...
#define PTE_MASK 0xbfffffffffffffff
...
#define CPU_INTERRUPT_IINM CPU_INTERRUPT_TGT_EXT_4
...
G_NORETURN void dynamic_excp(CPUSW64State *env, uintptr_t retaddr, int excp,
    int error);
G_NORETURN void arith_excp(CPUSW64State *env, uintptr_t retaddr, int exc,
    uint64_t mask);
