/*
 * sw64-dis.c -- Disassemble SW64 instructions
...
#define FMALIT          (F3 + 1)
    { 5,  5, -FMALIT, SW_OPERAND_UNSIGNED, 0, 0 },
...
int print_insn_sw64(bfd_vma memaddr, struct disassemble_info *info)
{
    ...
    switch (info->mach) {
        case bfd_mach_sw64_core3:
            ...
            break;
	case bfd_mach_sw64_core4:
	    isa_mask |= SW_OPCODE_BASE | SW_OPCODE_CORE4;
	    break;
    }
